...
*/
typedef void (*ApplicationCloseHandler)();
...
public:
    ...
    void setCloseHandler(ApplicationCloseHandler onCloseHandler);
	...
	*/
    ...
    //MAXVAS
protected:
    ApplicationCloseHandler onClose;
...
frontend::Application * createApplication(int & argc, char * argv[]);//MAXVAS
